...
class NaverNewsLister:
    ...
    def crawler(self):
        ...
        while s_page < maxpage_t:
            ...
            url = "https://search.naver.com/search.naver?where=news&query="+keyword+"&sort=0&ds="+stdate+"&de="+endate+"&nso=so%3Ar%2Cp%3Afrom"+s_from+"to"+e_to+"%2Ca%3A&start="+str(s_page)
