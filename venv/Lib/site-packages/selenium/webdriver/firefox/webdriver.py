...
class WebDriver(RemoteWebDriver):
    ...
    executable_path = dir+'\\'+'geckodriver.exe'
    service_log_path = dir+'\\'+'geckodriver.log'
    ...
    def __init__(self, firefox_profile=None, firefox_binary=None,
                 ...
                 service_log_path=service_log_path, firefox_options=None,
                 service_args=None, desired_capabilities=None, log_path=None,
                 keep_alive=True):
        print('executable_path=',executable_path)
        print('log_path=', service_log_path)
